Review the `workleap-telemetry` skill you created in the `./skills/workleap-telemetry` directory and make sure that all API definition and examples match the current documentation available in the `./docs` folder. Ignore anything related standalone libraries. Do not make any mistake.
